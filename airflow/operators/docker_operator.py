...
from airflow.configuration import AIRFLOW_TMP, AIRFLOW_SVN, HADOOP_CONF_PATH, HIVE_CONF_PATH, SPARK_CONF_PATH, HIVE_CONF_URL, HADOOP_CONF_URL, UGI_URL, SPARK_CONF_ORIGIN, DEFAULT_IMAGE, EXTRA_HOSTS, RSYNC_PROXY
